...
-- Replace 'admin@example.com' with your preferred admin email
...
-- Note: You'll need to actually sign up with admin@example.com through the normal signup flow first
