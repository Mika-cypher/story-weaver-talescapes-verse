...
export const StoryList: React.FC<StoryListProps> = ({
  ...
  // Get stories - use provided stories or fetch from service
  let stories: Story[] = [];
  if (providedStories) {
    stories = providedStories;
  } else {
    // Get published stories from service
    const publishedStories = storyService.getPublishedStories();
    ...
    stories = [...publishedStories, ...sampleCommunityStories];
  }
