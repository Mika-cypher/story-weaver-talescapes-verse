...
import { Plus, Trash, Eye, Star, StarOff, FileCheck, FileMinus } from "lucide-react";
...
const AdminStories: React.FC = () => {
  ...
  const toggleFeatured = (id: string, featured: boolean) => {
    storyService.updateStoryFeatured(id, featured);
    toast({
  ...
  const toggleStatus = (id: string, status: "draft" | "published") => {
